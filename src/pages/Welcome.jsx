...
export default function WelcomePage() {
  ...
  const opacityCity = useTransform(scrollY, [0, 250, 500], [1, 0.5, 0]);

  const yHero = useTransform(scrollY, [0, 200], [0, -150]);
  const opacityHero = useTransform(scrollY, [0, 250, 500], [1, 1, 0]);

  const yText = useTransform(scrollY, [0, 250, 500], [0, 50, 300]);
